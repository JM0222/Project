	...
	const sceneInfo = [
		{
			...
			values: {
				...
				pencilLogo_opacity_out: [1, 0, { start: 0.85, end: 0.9 }],
				path_dashoffset_in: [3394, 0, { start: 0.2, end: 0.4 }],
				path_dashoffset_out: [0, -3394, { start: 0.6, end: 0.8 }]
			}
		}
	];

	function setLayout() {
		// 각 scene scroll 길이 셋팅
